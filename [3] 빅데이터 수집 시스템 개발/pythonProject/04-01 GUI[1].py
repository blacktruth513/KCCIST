...
lable1 = Label(window, text="안녕하세요");
lable2 = Label(window, text="안녕하세요" ,font=("궁서체",30), fg="red");
lable3 = Label(window, text="안녕하세요" ,font=("궁서체",30), fg="red", bg="blue");
#그림 삽입349
#파이썬은 gif파일만 인식한다.
...
button1 = Button(window, text='command 없는 버튼', fg='red');
#command 뒤에 나오는 clickButton은 콜뱃함수로 괄호가 붙지않는다.
button2 = Button(window, text='command 있는 버튼', fg='red', command=clickButton);
